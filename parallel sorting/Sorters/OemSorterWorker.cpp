...
{	
	...
	//cout<<"CompSplit: "<<myId<<"<->"<<idProcess<<endl;
	MPI_Isend( buffer, bufSize, MPI_INT, idProcess, WORK_TAG+50, MPI_COMM_WORLD, &request );
	...
	//cout<<"CompSplit finished: "<<myId<<"<->"<<idProcess<<endl;
